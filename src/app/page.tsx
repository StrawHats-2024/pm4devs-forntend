...
//   // }
//   const handlePasswordClick = (password: any) => {
//     setSelectedPasswordId(password.id);
//     setSelectedPasswordData({ encryptedData: password.encrypted_data, iv: password.iv, name: password.name });
// }
...
//                            Last updated: {moment(password.created_at).format('h:mm A MMM DD, YYYY')}
//                           </p>
//                      </div>
//                     </div>
//                    ))}
...
//         encryptedData={selectedPasswordData.encryptedData} 
  ...
  useEffect(() => {
    const fetchPasswords = async () => {
      try {
        ...
        const data = await response.json();
        setPasswords(data.data); // Assuming data.data contains the passwords
